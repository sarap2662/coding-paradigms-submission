...
no, the function is impure because it modifies the external state

# Is this solution a higher order function? Why or why not?
no, does not take a function as an argument and doesnt return a
#function
...
The use of pure functions, immmutability, higher order functions, declaritve rather than
